# Generated by Django 2.2.9 on 2020-02-16 19:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_already', models.IntegerField(verbose_name='已筹金额')),
                ('p_status', models.CharField(choices=[('readyto', '即将开始'), ('funding', '众筹中'), ('success', '众筹成功'), ('failed', '众筹失败')], max_length=20, verbose_name='项目状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('g_sold', models.IntegerField(verbose_name='商品已定数量')),
